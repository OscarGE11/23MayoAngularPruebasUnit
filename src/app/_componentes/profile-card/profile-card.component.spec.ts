...
describe('ProfileCardComponent', () => {
  ...
  it('debería mostrar el nombre completo', () => {
    ...
    const testUser= {_id:'12345',first_name:"Mario",last_name:"Girón",
      email:"mario@gmail.com",username:"mariog",id:3,image:'',password:'1212'};
  ...
  it('deberia modificar el color de fondo cuando hagamos click', ()=>{
